...
@section('title', 'Add New Card  | Driver')
@section('content')
        ...
        <div class="col-xs-12 col-sm-12">
            ...
            <div class="rest-container">
                <div class="scan-your-card-container-none">
                    ...
                    <div class="scan-your-card-prompt">
                        <div class="position-relative scan-your-card-icon">
                            <div class="float-right mastercard-icon">
                                <img src="{{ asset('mobile-app-assets/icons/mastercard.svg') }}" alt="Mastercard Icon" />
                            </div>
                            <img class="img-responsive w-100 photocamera-icon" src="{{ asset('mobile-app-assets/icons/photocamera.svg') }}"
                                alt="Camera Icon" />
                    ...
                    <div class="card-info-container font-weight-light">
                        ...
                        <div class="float-right">
                            <div class="font-weight-light">
                                <span class="label-title"> CVV / CVC </span>
                    ...
                    <div class="card-info-container font-weight-light">
                        <div class="card-number">
                            <div class="form-group">
                                <label class="width-100 label-title">
                                    Card Holder Name
                                    <input class="input-group" type="text" autocomplete="off" value="Jonathan McBerly"
                    ...
                    <div class="btn-save">
                        <a href="credit-cards.html" class="btn btn-primary">Save Card <span class="far fa-save"></span></a>
                    </div>
                </div>
            </div>
        </div>
