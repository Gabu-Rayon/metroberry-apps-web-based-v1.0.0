...
@section('title', 'Add Address | Customer')
@section('content')
        ...
        <div class="col-xs-12 col-sm-12">
            ...
            <div class="rest-container">
                <div class="text-center header-icon-logo-margin">
                    <img src="mobile-app-assets/images/logo-main.svg" alt="Main Logo">
                </div>
                ...
                <div class="sign-up-form-container text-center">
                    <form class="width-100">
                        <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span>
                                        <img src="mobile-app-assets/icons/marker.svg" alt="Marker Icon">
                                    </span>
                                </div>
                        ...
                        <div class="form-submit-button">
                            <a href="addresses.html" class="btn btn-dark text-uppercase">Save <span
                                    class="far fa-save save-icon"></span></a>
                        </div>
                    </form>
                </div>
                <!-- Add New Address End-->
