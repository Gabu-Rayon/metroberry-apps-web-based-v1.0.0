...
$(document).ready(function () {
    ...
    $(document).on(
        "click",
        ".sign-in-item.border-bottom-light-grey",
        function () {
            $(".sign-in-item")
    ...
    $(document).on("click", ".request-ride-info .slide-up", function () {
        ...
        $(".request-ride-info .notification-container").toggleClass(
            "addAddress"
        );
...
function togglePaymentOptionsContainer() {
    if (
        $(".payment-options-intro-container").find(".fa-chevron-down").length ==
        0
    ) {
...
function initMap() {
    ...
    const defaultLocation = { lat: 42.1945, lng: -71.8356 }; // Fallback location if geolocation fails
...
function AutocompleteDirectionsHandler(map) {
    ...
    $(".map-input .remove")
        ...
        .on("click", function () {
            ...
            if (
                $(this).closest(".map-input").find("input").attr("id") ==
                "origin-input"
            ) {
    ...
    var originInputContainer = document.getElementById(
